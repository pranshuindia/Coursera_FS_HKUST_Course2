...
import {Breadcrumb, BreadcrumbItem, Form, Button, FormGroup, Label, Input, Col, FormFeedback, Row} from "reactstrap";
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger"
                                            ...
                                            messages={{
                                                required: 'Required',
                                                minLength: 'Must be greated than 2',
                                                maxLength: 'Must be lesser than 15'
                                            }}
                                    />
                                </Col>
                            </Row>
